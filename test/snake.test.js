...
import { createGame, directions, directionFromKey } from '../app.js';

const alwaysFirstFreeCell = () => 0;

describe('snake game core', () => {
  it('initializes a 20x20 board with a centered moving snake, free-cell food, and zero score', () => {
  ...
  it('moves continuously and prevents direct 180 degree reversal', () => {
    const game = createGame({ random: alwaysFirstFreeCell });
